...
def downgrade():
    op.drop_index("ix_brand_cta_templates_template_name", "brand_cta_templates")
    op.drop_index("ix_brand_cta_templates_brand_space_id", "brand_cta_templates")
    op.drop_table("brand_cta_templates")
    op.drop_index("ix_brand_legal_assets_asset_type", "brand_legal_assets")
    op.drop_index("ix_brand_legal_assets_brand_space_id", "brand_legal_assets")
